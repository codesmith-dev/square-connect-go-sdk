 ...
 * @param optional nil or *RefundsApiListPaymentRefundsOpts - Optional Parameters:
     ...
     * @param "Status" (optional.String) -  If provided, only refunds with the given status are returned. For a list of refund status values, see &#x60;PaymentRefund&#x60;.  Default: If omitted, refunds are returned regardless of their status.
