 ...
 * @param optional nil or *RefundsApiListPaymentRefundsOpts - Optional Parameters:
     ...
     * @param "Status" (optional.String) -  If provided, only refunds with the given status are returned. For a list of refund status values, see [PaymentRefund](https://developer.squareup.com/reference/square_2024-07-17/objects/PaymentRefund).  Default: If omitted, refunds are returned regardless of their status.
