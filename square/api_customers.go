...
/*
CustomersApiService BulkCreateCustomers
...
*/
func (a *CustomersApiService) BulkCreateCustomers(ctx context.Context, body BulkCreateCustomersRequest) (BulkCreateCustomersResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue BulkCreateCustomersResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/customers/bulk-create"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BulkCreateCustomersResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CustomersApiService BulkDeleteCustomers
...
*/
func (a *CustomersApiService) BulkDeleteCustomers(ctx context.Context, body BulkDeleteCustomersRequest) (BulkDeleteCustomersResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue BulkDeleteCustomersResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/customers/bulk-delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BulkDeleteCustomersResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CustomersApiService BulkRetrieveCustomers
...
*/
func (a *CustomersApiService) BulkRetrieveCustomers(ctx context.Context, body BulkRetrieveCustomersRequest) (BulkRetrieveCustomersResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue BulkRetrieveCustomersResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/customers/bulk-retrieve"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BulkRetrieveCustomersResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CustomersApiService BulkUpdateCustomers
...
*/
func (a *CustomersApiService) BulkUpdateCustomers(ctx context.Context, body BulkUpdateCustomersRequest) (BulkUpdateCustomersResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue BulkUpdateCustomersResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/customers/bulk-update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BulkUpdateCustomersResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
