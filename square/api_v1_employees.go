 ...
 * @param optional nil or *V1EmployeesApiListCashDrawerShiftsOpts - Optional Parameters:
     * @param "Order" (optional.String) -  The order in which cash drawer shifts are listed in the response, based on their created_at field. Default value: ASC
 ...
 * @param optional nil or *V1EmployeesApiListEmployeeRolesOpts - Optional Parameters:
     * @param "Order" (optional.String) -  The order in which employees are listed in the response, based on their created_at field.Default value: ASC
 ...
 * @param optional nil or *V1EmployeesApiListEmployeesOpts - Optional Parameters:
     ...
     * @param "Status" (optional.String) -  If provided, the endpoint returns only employee entities with the specified status (ACTIVE or INACTIVE).
 ...
 * @param optional nil or *V1EmployeesApiListTimecardsOpts - Optional Parameters:
     * @param "Order" (optional.String) -  The order in which timecards are listed in the response, based on their created_at field.
