 ...
 * @param optional nil or *GiftCardsApiListGiftCardsOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  If a [type](https://developer.squareup.com/reference/square_2024-07-17/enums/GiftCardType) is provided, the endpoint returns gift cards of the specified type. Otherwise, the endpoint returns gift cards of all types.
     * @param "State" (optional.String) -  If a [state](https://developer.squareup.com/reference/square_2024-07-17/enums/GiftCardStatus) is provided, the endpoint returns the gift cards in the specified state. Otherwise, the endpoint returns the gift cards of all states.
