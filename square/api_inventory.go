...
Deprecated version of [RetrieveInventoryAdjustment](https://developer.squareup.com/reference/square_2024-07-17/inventory-api/retrieve-inventory-adjustment) after the endpoint URL is updated to conform to the standard convention.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param adjustmentId ID of the [InventoryAdjustment](https://developer.squareup.com/reference/square_2024-07-17/objects/InventoryAdjustment) to retrieve.
...
Deprecated version of [RetrieveInventoryPhysicalCount](https://developer.squareup.com/reference/square_2024-07-17/inventory-api/retrieve-inventory-physical-count) after the endpoint URL is updated to conform to the standard convention.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param physicalCountId ID of the [InventoryPhysicalCount](https://developer.squareup.com/reference/square_2024-07-17/objects/InventoryPhysicalCount) to retrieve.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param catalogObjectId ID of the [CatalogObject](https://developer.squareup.com/reference/square_2024-07-17/objects/CatalogObject) to retrieve.
 * @param optional nil or *InventoryApiRetrieveInventoryChangesOpts - Optional Parameters:
     * @param "LocationIds" (optional.String) -  The [Location](https://developer.squareup.com/reference/square_2024-07-17/objects/Location) IDs to look up as a comma-separated list. An empty list queries all locations.
...
Returns the [InventoryTransfer](https://developer.squareup.com/reference/square_2024-07-17/objects/InventoryTransfer) object with the provided &#x60;transfer_id&#x60;.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param transferId ID of the [InventoryTransfer](https://developer.squareup.com/reference/square_2024-07-17/objects/InventoryTransfer) to retrieve.
