...
/*
V1TransactionsApiService ListOrders
Provides summary information for a merchant&#x27;s online store orders.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param locationId The ID of the location to list online store orders for.
 * @param optional nil or *V1TransactionsApiListOrdersOpts - Optional Parameters:
     * @param "Order" (optional.String) -  TThe order in which payments are listed in the response.
...
/*
V1TransactionsApiService RetrieveOrder
...
/*
V1TransactionsApiService UpdateOrder
