...
**CatalogObjectId** | **string** | The catalog object ID referencing the service charge &#x60;CatalogObject&#x60;. | [optional] [default to null]
...
**CalculationPhase** | **string** | The calculation phase at which to apply the service charge. See [OrderServiceChargeCalculationPhase](#type-orderservicechargecalculationphase) for possible values | [optional] [default to null]
