...
------------ | ------------- | ------------- | -------------
**Version** | **int32** | The version of the &#x60;Invoice&#x60; to publish. This must match the current version of the invoice, otherwise the request is rejected. | [default to null]
