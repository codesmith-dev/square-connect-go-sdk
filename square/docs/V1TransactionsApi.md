...
# **ListOrders**
> []V1Order ListOrders(ctx, locationId, optional)
ListOrders
 ...
 **optional** | ***V1TransactionsApiListOrdersOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a V1TransactionsApiListOrdersOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **order** | **optional.String**| TThe order in which payments are listed in the response. | 
...
# **RetrieveOrder**
> V1Order RetrieveOrder(ctx, locationId, orderId)
RetrieveOrder
...
# **UpdateOrder**
> V1Order UpdateOrder(ctx, body, locationId, orderId)
UpdateOrder
