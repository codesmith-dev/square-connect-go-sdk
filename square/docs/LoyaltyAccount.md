...
**ProgramId** | **string** | The Square-assigned ID of the [loyalty program](https://developer.squareup.com/reference/square_2024-07-17/objects/LoyaltyProgram) to which the account belongs. | [default to null]
...
**CustomerId** | **string** | The Square-assigned ID of the [customer](https://developer.squareup.com/reference/square_2024-07-17/objects/Customer) that is associated with the account. | [optional] [default to null]
