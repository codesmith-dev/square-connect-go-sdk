...
**OrderId** | **string** | The ID of the &#x60;order&#x60; for which the invoice is created.  This order must be in the &#x60;OPEN&#x60; state and must belong to the &#x60;location_id&#x60; specified for this invoice. This field is required when creating an invoice. | [optional] [default to null]
...
**DeliveryMethod** | [***InvoiceDeliveryMethodInvoiceDeliveryMethod**](invoice_delivery_methodInvoiceDeliveryMethod.md) |  | [optional] [default to null]
...
**Status** | **string** | The status of the invoice. See [InvoiceStatus](#type-invoicestatus) for possible values | [optional] [default to null]
