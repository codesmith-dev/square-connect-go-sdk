...
**TeamMemberId** | **string** | An optional ID of the [TeamMember](https://developer.squareup.com/reference/square_2024-07-17/objects/TeamMember) associated with taking the payment. | [optional] [default to null]
...
**IsOfflinePayment** | **bool** | Whether or not this payment was taken offline. | [optional] [default to null]
