...
See the corresponding object definition for field details.
  - @param invoiceId The ID of the [invoice](https://developer.squareup.com/reference/square_2024-07-17/objects/Invoice) to cancel.
...
Removes an attachment from an invoice and permanently deletes the file. Attachments can be removed only from invoices in the &#x60;DRAFT&#x60;, &#x60;SCHEDULED&#x60;, &#x60;UNPAID&#x60;, or &#x60;PARTIALLY_PAID&#x60; state.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param invoiceId The ID of the [invoice](https://developer.squareup.com/reference/square_2024-07-17/objects/Invoice) to delete the attachment from.
  - @param attachmentId The ID of the [attachment](https://developer.squareup.com/reference/square_2024-07-17/objects/InvoiceAttachment) to delete.
